...
public class Session {
     ...
     * @param lat
     */
    public Session(Integer centerId, String name, String address, String stateName, String districtName, String blockName, Integer pincode, String from, String to, Float lat, Float _long, String feeType, String sessionId, String date, Integer availableCapacity, Integer availableCapacityDose1, Integer availableCapacityDose2, String fee, Integer minAgeLimit, String vaccine, List<Slot> slots) {
        super();
